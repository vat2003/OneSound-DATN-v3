...
@Component({
  ...
  templateUrl: './user-playsong.component.html',
  styleUrls: ['./user-playsong.component.scss']
})
export class UserPlaysongComponent implements OnInit {
  songs: Song[] = [];

  // constructor(private matDialog: MatDialog, private songService: SongService) {}
  constructor(private matDialog: MatDialog, private songService: SongService, private playlistInteractionService: PlaylistInteractionService) {}
