...
function sign(message, privateKey) {
  return __async(this, null, function* () {
    ...
    const { prefix, scalar, pointBytes } = yield getExtendedPublicKey(privateKey);
    const r = modlLE(yield utils.sha512(prefix, message));
    const R = Point.BASE.multiply(r);
    const k = modlLE(yield utils.sha512(R.toRawBytes(), pointBytes, message));
...
function verify(sig, message, publicKey) {
  return __async(this, null, function* () {
    ...
    const hashed = yield utils.sha512(r.toRawBytes(), pub.toRawBytes(), msg);
...
var utils = {
  ...
  sha512: (...messages) => __async(void 0, null, function* () {
    ...
    if (crypto2.web) {
      const buffer = yield crypto2.web.subtle.digest("SHA-512", message.buffer);
...
*/
//# sourceMappingURL=chunk-4OTWA2VP.js.map
